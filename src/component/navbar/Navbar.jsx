...
const Navbar = () => {
  ...
  return (
    ...
    >
      <div
        className={`flex items-center justify-between px-6 py-3 md:py-4 max-md:rounded-t-none shadow max-w-[1200px] rounded-full m-auto transition-colors duration-300 ${
          theme === "dark"
